...
<body>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Koach</span> </a>
            <ul>
              <li><a href="about.html">Histoire Koach</a></li>
  ...
  <section id="hero" class="hero">
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/H1.jpg)"></div>
  ...
  <footer id="footer" class="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              <h3>Koach</h3>
              <p>
                12 Rue sod maareb <br>
                24 Residence tarek ibn zied<br>
                Ennasr 2 Ariana 2037<br><br>
                <strong>Phone:</strong> +216 20 20 20 32<br>
                <strong>Phone:</strong> +216 55 27 20 32<br>
                <strong>Email:</strong> contact@coaching-kinesiology.tn<br>
              </p>
              <div class="social-links d-flex mt-3">
                <a href="https://www.facebook.com/profile.php?id=100063556660828"
    ...
    <div class="footer-legal text-center position-relative">
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>Koach</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
